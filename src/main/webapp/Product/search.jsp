                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <%
                                                            ...
                                                            List<Product> productList = (List<Product>) s.getAttribute("searchList");
                                                            
                                                            String header = (String) s.getAttribute("header");
                                                            ...
                                                            s.removeAttribute("searchList");
                                                            s.removeAttribute("header");
...
//
//                                                            if(pid != null) {
//                                                                out.println("<h3 class=\"m_1\">Sản phẩm tương tự:</h3>");
//                                                                productList = pd.recommendProduct(pid);
//                                                            }
//                                                            else {
//                                                                out.println("<h3 class=\"m_1\">Kết quả tìm kiếm</h3>");
//                                                                if (keyWord != null && !keyWord.equals("Tìm kiếm") && price == null) {
//                                                                    productList = pd.getSearchProduct(keyWord);
//                                                                }
//                                                                else {//else if (keyWord == null && (price != null || categories.length > 0 || discount != null)) {
//    //                                                                out.println("<h1>" + price + " " + categories.length + " " + discount + "</h1>");
//    //                                                                productList = pd.getSearchProductByPrice(low, up);
//                                                                    productList = pd.getSearchProductByMultipleCriteria(categories, discount, price);
//                                                                }
//                                                            }
