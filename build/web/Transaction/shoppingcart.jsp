...
//                response.sendRedirect("../User/login.jsp");
                ...
                out.write("<script type='text/javascript'>\n");
                out.write("alert('You must login as a customer to view the shopping cart!!!');\n");
                String url = "../User/login.jsp";
                out.write("window.location.href='" + url + "';");
                out.write("</script>\n");
//                response.sendRedirect("../User/login.jsp");
            ...
            <div class="container">
                <div class="check_box">	 
                    <div class="col-md-9 cart-items">
                        ...
                        <c:forEach var="p" items="${cart}">
                            <div class="cart-header">
                                ...
                                <a href="#" id="delBtn${p.pid}"><div class="close1"></div></a>  

                                <script>

                                    document.getElementById("delBtn${p.pid}").addEventListener('click', function () {
                                        var acc = confirm("Xin Vui Lòng Xác Nhận Xóa Khỏi Giỏ Hàng");

                                        if (acc == true) {
                                            window.location.href = '../shoppingcart.ShoppingServlet?action=delete&pid=${p.pid}';
                                        }
                                ...
                                <div class="cart-sec simpleCart_shelfItem">
                                    ...
                                    <div class="cart-item-info">
                                        ...
                                        <div class="delivery">
                                            ...
                                            <span>Vận chuyển từ 2-3 ngày</span>
                                            <div class="clearfix"></div>
                                        </div>	
                                    </div>
                                    <div class="clearfix"></div>
                    ...
                    <div class="col-md-3 cart-total">
                        ...
                        <a class="order" href="../Transaction/checkout.jsp">Thanh Toán</a>
